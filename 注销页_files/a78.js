var RadiusErrorAry = new Array(54);
...
RadiusErrorAry[49]="0|Rad:Authentication Fail ErrCode=09|本账号费用超支，禁止使用(Online time / flow rate has been to the limit)|Online time / flow rate has been to the limit";
RadiusErrorAry[50]="0|Rad:userid error1|账号不存在(Account does not exist)|Account does not exist";
RadiusErrorAry[51]="0|Rad:userid error2|密码错误(Password Error)|Password Error";
RadiusErrorAry[52]="0|Rad:ldap auth error|您的数字化校园用户或密码错误，请重新输入！(Your digital campus user or password error, please re-enter!)|Your digital campus user or password error, please re-enter!";
RadiusErrorAry[53]="0|Rad:Authentication Fail ErrCode=05|您的账号已停机。Your account has been shut down|Your account has been shut down";